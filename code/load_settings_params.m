...
% params.time_interval = '550:600'; % set to zero if you want to take optimal bins per neurons for mat files
% params.time_interval = '609:759'; % set to zero if you want to take optimal bins per neurons for mat files
% params.time_interval = '556:616';
% params.time_interval = '565:715';
% params.time_interval = '500:800';
